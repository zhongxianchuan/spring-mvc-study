...
<link href="<%=contextPath%>/resources/css/share.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<div class="newblog left">
   ...
   <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>模板分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
    <figure><img src="<%=contextPath%>/resources/images/01.jpg"></figure>
    <ul class="nlist">
   ...
   <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>模板分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
    <figure><img src="<%=contextPath%>/resources/images/02.jpg"></figure>
    <ul class="nlist">
   ...
   <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>模板分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
    <figure><img src="<%=contextPath%>/resources/images/03.jpg"></figure>
    <ul class="nlist">
    ...
    <div class="line"></div>
         <h2>女生清新个人博客网站模板</h2>
   <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>模板分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
    <figure><img src="<%=contextPath%>/resources/images/04.jpg"></figure>
    <ul class="nlist">
