...
<link href="<%=contextPath%>/resources/css/template.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<article class="blogs">
  ...
  <div class="index_about">
    ...
    <ul class="infos">
      ...
      <p><img src="<%=contextPath%>/resources/images/5416dd08017075c692766f67049890d4.jpg" alt="仿新浪博客风格·梅——古典个人博客模板"></p>
