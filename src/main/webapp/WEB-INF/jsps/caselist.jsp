...
<link href="<%=contextPath%>/resources/css/case.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<ul>
<li><a href="/"><img src="<%=contextPath%>/resources/images/01.jpg"></a></li>
<li><a href="/"><img src="<%=contextPath%>/resources/images/02.jpg"></a></li>
<li><a href="/"><img src="<%=contextPath%>/resources/images/03.jpg"></a></li>
<li><a href="/"><img src="<%=contextPath%>/resources/images/04.jpg"></a></li>
